...
class Http {
   ...
   * @return mixed response
   */
  public static function httpPut($url, $data, $header = '', $agent = '', $timeout = 3000) {
  
    return self::httpRequest($url, $data, $header, 'put', $agent, $timeout);
   ...
   * @return mixed response
   */
  public static function httpDelete($url, $data, $header = '', $agent = '', $timeout = 3000) {
  
    return self::httpDelete($url, $data, $header, 'delete', $agent, $timeout); 
