...
return array(
    ...
    // 逆地址解析（坐标位置描述）请求URL
    'get_address_uri' => 'http://apis.map.qq.com/ws/geocoder/v1/?location={LAT},{LNG}&key={KEY}',
    ...
    // 查询距离
    'get_distance_uri' => 'https://apis.map.qq.com/ws/distance/v1/?mode=walking&from={FROM}&to={TO}&key={KEY}'
